  ...
  methods: {
          ...
          case "shop":
            ...
            switch(this.all_tags[key]){
              ...
              this.type_node = "icon_clothes2";
                break;
              case "pet":
              this.type_node = "icon_dog2";
                break;
              case "books":
                this.type_node = "icon_book2";
                break;
              case "optician":
                this.type_node = "icon_op2";
                break;
              case "shoes":
                this.type_node = "icon_shoe2";
                break;
              case "cosmetics":
                this.type_node = "icon_cosmetic2";
                break;
              case "interior_decoration":
                this.type_node = "icon_deco2";
                break;
              case "furniture":
                this.type_node = "icon_furniture2";
                break;
              case "houseware":
                this.type_node = "icon_houseware2";
                break;
              case "garden_centre":
                this.type_node = "icon_florist2";
                break;
              case "bathroom_furnishing":
                this.type_node = "icon_bath2";
                break;
            }
            break;
          case "tourism":
          ...
          case "amenity":
            ...
            switch(this.all_tags[key]){
              ...
              this.type_node = "icon_housedog2";
                break;
              case "drinking_water":
              this.type_node = "icon_water2";
                break;
              case "toilets":
              this.type_node = "icon_wc2";
                break;
            }
            break;
          case "brand":
    ...
    translateItem: function (item) {
      switch (item) {
        ...
        case "interior_decoration":
          return "Decoración de interiores";
        case "furniture":
          return "Muebles";
        case "houseware":
          return "Articulos de hogar";
        case "garden_centre":
          return "Centro de jardinería";
        case "bathroom_furnishing":
          return "Muebles baño";
        case "drinking_water":
          return "Agua potable";
...
.icon_burger2 {
  background-image: url("data:image/svg+xml,%3Csvg version='1.1' id='Capa_1' width='100%' height='100%' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 330 330' style='enable-background:new 0 0 330 330;' xml:space='preserve'%3E%3Cg%3E%3Cg%3E%3Cg%3E%3Cg%3E%3Cg%3E%3Cpath d='M79.947,122.693c-1.97,0-3.9-0.8-5.3-2.189c-1.4-1.4-2.2-3.33-2.2-5.311c0-1.97,0.8-3.899,2.2-5.3 c1.4-1.4,3.33-2.2,5.3-2.2c1.97,0,3.91,0.8,5.3,2.2c1.4,1.4,2.2,3.33,2.2,5.3c0,1.98-0.8,3.91-2.2,5.311 C83.857,121.893,81.917,122.693,79.947,122.693z'/%3E%3C/g%3E%3Cg%3E%3Cpath d='M164.997,122.693c-1.969,0-3.899-0.8-5.299-2.189c-1.4-1.4-2.2-3.33-2.2-5.311c0-1.97,0.8-3.899,2.2-5.3 c1.4-1.4,3.33-2.2,5.299-2.2c1.971,0,3.91,0.8,5.311,2.2c1.391,1.4,2.189,3.33,2.189,5.3c0,1.98-0.799,3.91-2.189,5.311 C168.907,121.893,166.967,122.693,164.997,122.693z'/%3E%3C/g%3E%3Cg%3E%3Cpath d='M250.047,122.693c-1.971,0-3.9-0.8-5.301-2.189c-1.399-1.4-2.199-3.33-2.199-5.311c0-1.97,0.8-3.899,2.199-5.3 c1.4-1.4,3.33-2.2,5.301-2.2c1.98,0,3.91,0.8,5.3,2.2c1.399,1.4,2.2,3.33,2.2,5.3c0,1.98-0.801,3.91-2.2,5.311 C253.958,121.893,252.028,122.693,250.047,122.693z'/%3E%3C/g%3E%3C/g%3E%3Cg%3E%3Cg%3E%3C
95.642,195.575,98.697,197.839,102.541,199.689z M42.689,214.689h244.622 c7.57,0,13.729,6.157,13.729,13.727c0,7.57-6.158,13.729-13.729,13.729H42.689c-7.57,0-13.729-6.158-13.729-13.729 C28.96,220.846,35.119,214.689,42.689,214.689z M15,127.796c0-22.504,15.09-43.951,42.489-60.391 c28.599-17.159,66.78-26.609,107.511-26.609c40.729,0,78.91,9.45,107.51,26.609c27.4,16.439,42.49,37.887,42.49,60.391 c0,13.234-10.767,24.002-24,24.002H39C25.766,151.798,15,141.031,15,127.796z M298.006,289.204H31.994 c-9.371,0-16.994-9.4-16.994-20.955c0-6.708,1.183-11.105,16.994-11.105h266.012c15.811,0,16.994,4.397,16.994,11.105 C315,279.804,307.376,289.204,298.006,289.204z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E%0A");
}
.icon_water2 {
  background-image: url("data:image/svg+xml,%3Csvg version='1.1' id='Capa_1' width='100%' height='100%' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 203.027 203.027' style='enable-background:new 0 0 203.027 203.027;' xml:space='preserve'%3E%3Cpath d='M57.034,166.534c2.398,3.801,3.664,8.181,3.664,12.685c0,13.128-10.681,23.809-23.809,23.809S13.08,192.347,13.08,179.219 c0-4.522,1.276-8.919,3.692-12.731l13.664-23.069c1.351-2.28,3.803-3.678,6.453-3.678c2.649,0,5.103,1.398,6.453,3.678 L57.034,166.534z M190.514,43.376h-49.038v-1.025c0-4.142-3.357-7.5-7.5-7.5h-11.233v-6.495h30.661c4.143,0,7.5-3.358,7.5-7.5 v-4.251C160.903,7.449,153.454,0,144.298,0H76.017c-9.156,0-16.605,7.449-16.605,16.605v4.251c0,4.142,3.358,7.5,7.5,7.5h30.662 v6.495H86.339c-4.142,0-7.5,3.358-7.5,7.5v1.025H58.84c-27.156,0-49.249,22.093-49.249,49.25v25.194 c-2.69,1.139-4.578,3.804-4.578,6.909c0,4.142,3.358,7.5,7.5,7.5h4.578h35.714h4.103c4.142,0,7.5-3.358,7.5-7.5 c0-2.918-1.67-5.441-4.103-6.681v-16.932c0-4.429,3.603-8.032,8.032-8.032h10.502v2.547c0,4.142,3.358,7.5,7.5,7.5h47.636 c4.143,0,7.5-3.358,7.5-7.5v-0.329h49.038c4.143,0,7.5-3.358,7.5-7.5V50.876C198.014,46.734,194.656,43.376,190.514,43.376z'/%3E%3C/svg%3E%0A");
}
.icon_wc2 {
  background-image: url("data:image/svg+xml,%3Csvg width='100%' height='100%' viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill='var(--ci-primary-color, currentColor)' d='M132,139.824A61.912,61.912,0,1,0,70.088,77.912,61.981,61.981,0,0,0,132,139.824ZM132,48a29.912,29.912,0,1,1-29.912,29.912A29.947,29.947,0,0,1,132,48Z' class='ci-primary'/%3E%3Cpath fill='var(--ci-primary-color, currentColor)' d='M176,152H88a48.053,48.053,0,0,0-48,48V352H72V496H192V352h32V200A48.053,48.053,0,0,0,176,152Zm16,168H160V464H104V320H72V200a16.019,16.019,0,0,1,16-16h88a16.019,16.019,0,0,1,16,16Z' class='ci-primary'/%3E%3Cpath fill='var(--ci-primary-color, currentColor)' d='M370.088,139.824a61.912,61.912,0,1,0-61.912-61.912A61.981,61.981,0,0,0,370.088,139.824Zm0-91.824a29.912,29.912,0,1,1-29.912,29.912A29.947,29.947,0,0,1,370.088,48Z' class='ci-primary'/%3E%3Cpath fill='var(--ci-primary-color, currentColor)' d='M425.759,193.354a61.586,61.586,0,0,0-115.833-1.392L248,357.1V400h64v96H416V400h64V349.3ZM448,368H384v96H344V368H280v-5.1l59.889-159.7a29.585,29.585,0,0,1,55.645.669L448,354.7Z' class='ci-primary'/%3E%3C/svg%3E");
}
.icon_atm2{
  background-image: url("data:image/svg+xml,%3Csvg version='1.1' id='Capa_1' width='100%' height='100%' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 474.588 474.588' style='enable-background:new 0 0 474.588 474.588;' xml:space='preserve'%3E%3Cg%3E%3Cpath d='M113.294,158.122c-5.86,17.713-10.194,36.023-12.88,54.42c-0.444,3.04,1.011,6.042,3.671,7.579l83.1,47.98 c1.156,0.667,2.452,1.005,3.75,1.005c1.056,0,2.114-0.223,3.103-0.672c2.204-1.001,3.789-3.006,4.256-5.382 c2.798-14.244,6.554-28.541,11.162-42.494c9.231-27.908,21.933-54.567,37.752-79.233c1.106-1.726,1.458-3.829,0.974-5.821 s-1.763-3.699-3.538-4.724l-85.61-49.42c-3.452-1.993-7.863-0.936-10.037,2.407C133.986,106.852,121.973,131.869,113.294,158.122z M116.031,209.697c2.586-15.845,6.45-31.588,11.504-46.866c7.528-22.772,17.685-44.566,30.232-64.883l72.646,41.936 c-14.571,23.838-26.397,49.357-35.199,75.966c-3.704,11.214-6.879,22.641-9.477,34.094L116.031,209.697z'/%3E%3Cpath d='M132.283,164.4c-4.036,12.199-7.324,24.793-9.771,37.432c-0.608,3.141,0.843,6.321,3.613,7.92l47.763,27.577 c1.155,0.667,2.45,1.005,3.75,1.005c0.965,0,1.934-0.187,2.85-0.563c2.15-0.883,3.769-2.714,4.383-4.956 c1.699-6.203,3.581-12.437,5.594-18.53c7.583-22.924,17.445-45.192,29.315-66.183c2.026-3.583,0.786-8.129-2.779-10.187 l-51.007-29.445c-1.736-1.002-3.801-1.267-5.734-0.737c-1.933,0.53-3.573,1.813-4.555,3.56 C146.244,128.141,138.364,146.008,132.283,164.4z M138.301,199.462c2.185-10.253,4.944-20.439,8.224-30.352 c4.984-15.074,11.238-29.775,18.631-43.803l37.971,21.919c-10.755,19.913-19.793,40.855-26.903,62.352 c-1.087,3.291-2.137,6.621-3.143,9.964L138.301,199.462z'/%3E%3Cpath d='M119.219,250.066v25.532c0,2.68,1.43,5.155,3.75,6.495l66.334,38.298c1.16,0.67,2.455,1.005,3.75,1.005 c1.294,0,2.588-0.334,3.748-1.003c2.32-1.338,3.75-3.813,3.752-6.491l0.018-25.522c0.002-2.682-1.428-5.16-3.75-6.5l-66.352-38.308 c-2.32-1.34-5.18-1.34-7.5,0S119.219,247.386,119.219,250.066z M134.219,263.056l51.349,29.646l-0.006,8.208l-51.343-29.643 V263.056z'/%3E%3Cpath d='M251.464,160.235l15.581,8.996c3.587,2.071,4.816,6.658,2.745,10.245c-1.389,2.406-3.91,3.751-6.502,3.751 c-